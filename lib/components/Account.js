...
var _useModel2 = _interopRequireDefault(require("../hooks/useModel"));
...
var Account = function Account() {
  var _useModel = (0, _useModel2["default"])('user', function (data) {
    return data;
  }),
      user = _useModel.user,
      auth = _useModel.auth,
      signin = _useModel.signin,
      signout = _useModel.signout;
  ...
  if (user) {
    return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(_antd.Avatar, {
      shape: "square",
      size: "small",
    ...
    }, user.nickname), /*#__PURE__*/_react["default"].createElement(_antd.Button, {
      onClick: signout,
