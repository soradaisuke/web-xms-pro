...
var _XmsProProvider = _interopRequireDefault(require("./XmsProProvider"));
...
function App(_ref) {
  var layoutProps = _ref.layoutProps,
      propSettings = _ref.settings,
      models = _ref.models;

  var _useState = (0, _react.useState)((0, _merge2["default"])({
    title: '蜻蜓FM',
    menu: {
      autoClose: false
    },
  ...
  }, /*#__PURE__*/_react["default"].createElement(_XmsProProvider["default"], null, /*#__PURE__*/_react["default"].createElement(_reactRouterDom.BrowserRouter, null, /*#__PURE__*/_react["default"].createElement(_Provider["default"], {
    models: models
