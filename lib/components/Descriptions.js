...
function makeMergedRender(render, update, del, user, matchParams) {
  if (!render) {
    return null;
  }
...
function Descriptions(_ref) {
  ...
  var _useDescriptionsReque = (0, _useDescriptionCRUDRequests.useDescriptionsRequests)(requestConfig, matchParams, user, actionRef),
      update = _useDescriptionsReque.update,
      del = _useDescriptionsReque["delete"],
      retrieve = _useDescriptionsReque.retrieve;
