...
var Descriptions = function Descriptions(props) {
  ...
  var editableService = (0, _react.useMemo)(function () {
    if (editable.requestConfig) {
      return (0, _lodash.isFunction)(editable.requestConfig) ? editable.requestConfig(matchParams, user) : editable.requestConfig;
    }
  ...
  var editableUpdate = (0, _useDescriptionCRUDRequests.useDescriptionsUpdateRequest)(editableService);
  ...
  var newEditable = (0, _react.useMemo)(function () {
    if (editable) {
      return _objectSpread({
        onSave: function onSave(dataIndex, row) {
          return editableUpdate(_defineProperty({}, dataIndex, row[dataIndex])).then(function () {
