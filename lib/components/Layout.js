...
function validRoute(route, userPermissions) {
  if (!(0, _utils.hasPermission)(route.permissions, userPermissions)) {
    return null;
  }

  return _objectSpread(_objectSpread({}, route), {}, {
    routes: (0, _filter2["default"])(route.routes, function (r) {
...
function renderRoutes(props) {
  ...
  return (0, _concat2["default"])(children, (0, _map2["default"])(routes, function (r) {
...
function Layout(_ref) {
  ...
  var newRoute = (0, _react.useMemo)(function () {
    return user ? validRoute(route, user.permissions) : null;
  }, [route, user]);
