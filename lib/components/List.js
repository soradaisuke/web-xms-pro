...
var _excluded = ["rowKey", "requestConfig", "metas", "toolBarRender", "search", "params", "form", "formRef", "actionRef"],
    _excluded2 = ["sort"];
...
function List(_ref) {
  var rowKey = _ref.rowKey,
      ...
      params = _ref.params,
      form = _ref.form,
      propsFormRef = _ref.formRef,
      propsActionRef = _ref.actionRef,
  ...
  var formattedMetas = (0, _react.useMemo)(function () {
    ...
    if (sortMetas.length > 0) {
      var initialSortMeta = (0, _find2["default"])(newMetas, function (meta) {
      ...
      newMetas.sort = {
        ...
        title: '排序',
        valueType: 'formSet',
        initialValue: initialSortMeta ? [initialSortMeta.dataIndex, initialSortMeta.defaultSortOrder] : undefined,
        columns: [{
          valueEnum: (0, _mapValues2["default"])((0, _keyBy2["default"])(sortMetas, 'dataIndex'), 'title'),
          initialValue: initialSortMeta === null || initialSortMeta === void 0 ? void 0 : initialSortMeta.dataIndex,
          fieldProps: {
            style: {
              width: '150px'
            }
          ...
          initialValue: initialSortMeta === null || initialSortMeta === void 0 ? void 0 : initialSortMeta.defaultSortOrder
        }]
      };
    }
  ...
  var newSearch = (0, _react.useMemo)(function () {
    ...
    if (!(0, _find2["default"])((0, _values2["default"])(formattedMetas), function (c) {
  ...
  var listRetrieve = (0, _react.useCallback)(function (_ref2, _, f) {
    ...
    return retrieve(restParams, (sort === null || sort === void 0 ? void 0 : sort.length) === 2 ? _defineProperty({}, sort[0], sort[1]) : {}, f);
  }, [retrieve]);
