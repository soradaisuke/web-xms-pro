...
var _excluded = ["normalizeSubmitValues", "create", "requestConfig", "tableAction"];
...
var TableCreateForm = function TableCreateForm(props) {
  ...
  var service = (0, _react.useMemo)(function () {
    ...
    return (0, _lodash.isFunction)(requestConfig) ? service(matchParams) : requestConfig;
  }, [create, matchParams, requestConfig]);
  var req = (0, _useTableCRUDRequests.useTableCreateRequest)(service, tableAction);
