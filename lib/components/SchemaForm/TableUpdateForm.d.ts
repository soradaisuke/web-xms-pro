...
export declare type TableUpdateFormProps<T = CommonRecord, U = ParamsType> = RecordSchemaFormProps<T> & Required<Pick<ProTableProps<T, U>, 'rowKey'>> & {
...
declare const TableUpdateForm: React.FC<TableUpdateFormProps>;
