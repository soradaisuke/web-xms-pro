...
var _excluded = ["rowKey", "requestConfig", "columns", "toolBarRender", "search", "params", "form", "formRef", "actionRef"];
    ...
    return _objectSpread(_objectSpread({
      ...
      syncToUrl: function syncToUrl(values, type) {
        if ((0, _isFunction2["default"])(form === null || form === void 0 ? void 0 : form.syncToUrl)) {
          return form.syncToUrl((0, _defaultSyncToUrl["default"])(values, type), type);
        }

        return (0, _defaultSyncToUrl["default"])(values, type);
      }
    });
  }, [form]);
