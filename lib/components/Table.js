  ...
  var defaultSyncToUrl = (0, _react.useCallback)(function (values, type) {
    if (type === 'get') {
      ...
      (0, _lodash.forEach)((0, _lodash.keys)(newValues), function (key) {
        ...
        if ((0, _lodash.isMap)(column.valueEnum) && (0, _lodash.isNumber)((_column$valueEnum$key = column.valueEnum.keys()) === null || _column$valueEnum$key === void 0 ? void 0 : _column$valueEnum$key[0])) {
