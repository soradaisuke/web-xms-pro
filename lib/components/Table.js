...
var _TableCreateForm = _interopRequireDefault(require("./SchemaForm/TableCreateForm"));

var _useCRUDRequests = require("../hooks/useCRUDRequests");

var _TableUpdateForm = _interopRequireDefault(require("./SchemaForm/TableUpdateForm"));
    ...
    return toolBarRender ? function () {
      ...
      return toolBarRender.apply(void 0, [{
        defaultCreateButtonRender: function defaultCreateButtonRender(config) {
          return /*#__PURE__*/_react["default"].createElement(_TableCreateForm["default"], _extends({
...
function makeMergedRender(rowKey, render, update, del, requestConfig) {
  ...
  return function () {
    ...
    var defaultUpdateButtonRender = function defaultUpdateButtonRender(config) {
      return /*#__PURE__*/_react["default"].createElement(_TableUpdateForm["default"], _extends({
        rowKey: rowKey,
        record: record,
        tableAction: action,
        requestConfig: requestConfig
    ...
    return render.apply(void 0, [{
      ...
      defaultDeleteButtonRender: function defaultDeleteButtonRender() {
        ...
        return /*#__PURE__*/_react["default"].createElement(_antd.Popconfirm, _extends({
          ...
          okText: "\u786E\u5B9A",
          cancelText: "\u53D6\u6D88"
        }, popConfirmProps), /*#__PURE__*/_react["default"].createElement(_antd.Button, {
          danger: true,
          style: {
            marginRight: 10
          },
