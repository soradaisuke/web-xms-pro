...
function useMergedToolBarRender(toolBarRender, requestConfig, form, params, user) {
  ...
  var defaultSyncToUrl = (0, _react.useCallback)(function (values, type) {
    if (type === 'get') {
      ...
      (0, _lodash.forEach)((0, _lodash.keys)(newValues), function (key) {
        ...
        if ((0, _lodash.isMap)(column === null || column === void 0 ? void 0 : column.valueEnum) && (0, _lodash.isNumber)(column.valueEnum.keys().next().value)) {
