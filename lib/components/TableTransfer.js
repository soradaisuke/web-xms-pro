...
function TableTransfer(_ref) {
  ...
  var leftProps = (0, _react.useMemo)(function () {
    return (0, _merge2["default"])({}, defaultTableProps, tableProps, leftTableProps);
  }, [tableProps, leftTableProps]);
  var rightProps = (0, _react.useMemo)(function () {
    return (0, _merge2["default"])({}, defaultTableProps, tableProps, rightTableProps);
  ...
  (0, _react.useEffect)(function () {
    setTotalDataSource(function (prev) {
      return (0, _uniqBy2["default"])((0, _concat2["default"])(prev, transferDataSource || []), 'key');
    });
  }, [transferDataSource]);
  (0, _react.useEffect)(function () {
    setTotalDataSource(function (prev) {
      return (0, _uniqBy2["default"])((0, _concat2["default"])(prev, initialTargetDataSource || []), 'key');
    });
  ...
  var onDragSortEnd = (0, _react.useCallback)(function (newDataSource) {
    onTransferChange((0, _map2["default"])(newDataSource, function (_ref2) {
      var key = _ref2.key;
      return key;
    }));
  }, [onTransferChange]);
  var getTableDataSource = (0, _react.useCallback)(function (direction, filteredItems) {
    if (direction === 'left') {
      if (preserve || leftTableProps !== null && leftTableProps !== void 0 && leftTableProps.request) {
        return (0, _map2["default"])(transferDataSource, function (item) {
          return _objectSpread(_objectSpread({}, item), {}, {
            disabled: item.disabled || (0, _includes2["default"])(transferTargetKeys, item.key)
          });
        });
      }
    ...
    if (leftTableProps !== null && leftTableProps !== void 0 && leftTableProps.request) {
      return (0, _map2["default"])(transferTargetKeys, function (key) {
        return (0, _find2["default"])(totalDataSource, function (item) {
          return key === item.key;
        });
      });
    }
  ...
  return /*#__PURE__*/_react["default"].createElement(_transfer["default"], _extends({}, rest, {
