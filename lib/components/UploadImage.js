...
var UploadImage = function UploadImage(props) {
  var value = props.value,
      ...
      imgCropProps = props.imgCropProps,
  ...
  var user = (0, _useModel["default"])('user', function (data) {
    return data.user;
  });
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              setLoading(true);
              _context.next = 4;
              return (0, _webCommon.uploadToUpyun)(info.file, {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 3:
              ...
              _antd.message.error("\u56FE\u7247\u5BBD\u5EA6\u5E94\u4E3A".concat(width, "\uFF0C\u5B9E\u9645\u4E3A").concat(size.width));
            ...
            case 7:
              ...
              _antd.message.error("\u56FE\u7247\u9AD8\u5EA6\u5E94\u4E3A".concat(height, "\uFF0C\u5B9E\u9645\u4E3A").concat(size.height));
