...
function useCreateRequest(serviceConfig, options, plugins) {
  ...
  var plugs = (0, _merge2["default"])({}, plugins);
  ...
  if ((0, _isString2["default"])(serviceConfig)) {
    ...
    (0, _merge2["default"])(opts, serviceConfig.useRequestOptions);
    (0, _merge2["default"])(plugs, serviceConfig.useRequestPlugins);
  }

  return (0, _request.useRequest)(service, opts, plugs);
}
