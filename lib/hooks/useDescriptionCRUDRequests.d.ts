...
export declare type DescriptionsRequestConfig<TData = CommonRecord, TValues extends CommonRecord = CommonRecord> = RequestConfig<DescriptionsRetrieveServiceConfig<TData> & {
