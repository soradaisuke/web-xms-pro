...
function useFormListItemAction(form) {
  ...
  var setCurrentRowData = (0, _react.useCallback)(function (data) {
    if (form) {
      var oldTableDate = form.getFieldsValue() || {};
      var rowKeyName = context.listName;
      var updateValues = (0, _lodash.set)(oldTableDate, rowKeyName, _objectSpread(_objectSpread({}, form.getFieldValue(rowKeyName)), data || {}));
