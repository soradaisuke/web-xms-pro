...
function useTableCreateRequest(serviceConfig, action) {
  ...
  var createReq = (0, _useCRUDRequests.useCreateRequest)(serviceConfig, (0, _merge2["default"])({}, serviceConfig.useRequestOptions, {
    manual: true
...
function useTableRetrieveRequest(serviceConfig) {
  var _serviceConfig$useReq4;

  var req = (0, _useCRUDRequests.useRetrieveRequest)(serviceConfig, (0, _merge2["default"])({}, serviceConfig.useRequestOptions, {
    manual: true
