...
var _excluded = ["current", "pageSize"],
    _excluded2 = ["requestPath", "create", "update", "delete", "retrieve"];
...
function useTableRequests(requestConfig, matchParams, user, action) {
  var config = (0, _react.useMemo)(function () {
    ...
    var commonConfig = requestPath ? _objectSpread(_objectSpread({}, rest), {}, {
      requestPath: requestPath
    }) : null;
    return {
      create: create !== null && create !== void 0 ? create : commonConfig,
      update: update !== null && update !== void 0 ? update : commonConfig,
      "delete": del !== null && del !== void 0 ? del : commonConfig,
      retrieve: retrieve !== null && retrieve !== void 0 ? retrieve : commonConfig
    };
