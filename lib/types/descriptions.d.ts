...
export declare type XMSDescriptionsColumns = Omit<ProDescriptionsItemProps<CommonRecord>, 'valueType' | 'render'> & {
    /** @name 从数据获取跳转地址 */
    link?: LinkConfig;
    ...
    }, ...base: Parameters<ProDescriptionsItemProps<CommonRecord>['render']>) => ReturnType<ProDescriptionsItemProps<CommonRecord>['render']>;
};
