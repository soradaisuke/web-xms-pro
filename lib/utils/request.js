...
function makeErrorHandler(errorAdaptor) {
  return function (error) {
    var _error$request, _error$request$option, _error$request2, _error$request2$optio, _errorInfo4;
    ...
    if (errorInfo) {
      ...
      switch ((error === null || error === void 0 ? void 0 : (_error$request2 = error.request) === null || _error$request2 === void 0 ? void 0 : (_error$request2$optio = _error$request2.options) === null || _error$request2$optio === void 0 ? void 0 : _error$request2$optio.errorShowType) || ((_errorInfo4 = errorInfo) === null || _errorInfo4 === void 0 ? void 0 : _errorInfo4.showType)) {
