...
function makeErrorHandler(errorAdaptor) {
  return function (error) {
    var _error$request, _errorInfo4;
    ...
    if (errorInfo) {
      ...
      switch ((options === null || options === void 0 ? void 0 : options.errorShowType) || ((_errorInfo4 = errorInfo) === null || _errorInfo4 === void 0 ? void 0 : _errorInfo4.showType)) {
      ...
      _message2["default"].error(error.message || 'Request error, please retry.');
    }
...
function useRequest(service, options, plugins) {
  return (0, _useRequest2["default"])(service, options, plugins);
}
