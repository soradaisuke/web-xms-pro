...
var defaultErrorAdapter = function defaultErrorAdapter(resData, ctx) {
  var errorInfo = {
    success: resData.errcode === 0,
    errorCode: resData.errcode || ctx.res.status,
    errorMessage: resData.errmsg || (0, _toString2["default"])(resData)
  };
  return errorInfo;
};

var defaultResultAdapter = function defaultResultAdapter(resData) {
  return resData.data;
};
...
function makeErrorHandler(errorAdaptor) {
  return function (error) {
    ...
    var options = error === null || error === void 0 ? void 0 : (_error$request = error.request) === null || _error$request === void 0 ? void 0 : _error$request.options;

    if (options !== null && options !== void 0 && options.skipErrorHandler) {
      throw error;
    }
    ...
    if (errorInfo) {
      var _errorInfo2, _errorInfo3, _errorInfo4;

      var e = new Error((_errorInfo2 = errorInfo) === null || _errorInfo2 === void 0 ? void 0 : _errorInfo2.errorMessage);
      e.code = (_errorInfo3 = errorInfo) === null || _errorInfo3 === void 0 ? void 0 : _errorInfo3.errorCode;
      e.showType = (options === null || options === void 0 ? void 0 : options.errorShowType) || ((_errorInfo4 = errorInfo) === null || _errorInfo4 === void 0 ? void 0 : _errorInfo4.showType);
      (0, _showError["default"])(e);
    } else {
      (0, _showError["default"])(error);
    }
...
function extendRequestConfig(requestConfig) {
  var _requestConfig$errorC;

  var globalErrorAdaper = ((_requestConfig$errorC = requestConfig.errorConfig) === null || _requestConfig$errorC === void 0 ? void 0 : _requestConfig$errorC.adaptor) || defaultErrorAdapter;
  var globalResultAdaper = requestConfig.resultAdapter || defaultResultAdapter;
  request.extendOptions(_objectSpread({
    errorHandler: makeErrorHandler(globalErrorAdaper)
  }, requestConfig)); // 中间件统一返回数据格式

  request.use( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(ctx, next) {
      var req, res, options, resData, resultAdaptor, result;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              if (!(options !== null && options !== void 0 && options.skipFormatResult)) {
                _context.next = 6;
                break;
              }
            ...
            case 6:
              resData = options !== null && options !== void 0 && options.getResponse ? res.data : res;
              resultAdaptor = options.resultAdapter || globalResultAdaper;
              result = resultAdaptor(resData);
              ctx.res = options !== null && options !== void 0 && options.getResponse ? _objectSpread(_objectSpread({}, res), {}, {
                data: result
              }) : result;
  ...
  request.use( /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(ctx, next) {
      var req, res, options, getResponse, resData, errorAdaptor, errorInfo, _error;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 6:
              ...
              errorAdaptor = options.errorAdaptor || globalErrorAdaper;
    ...
    if (options.method === 'put') {
      return {
        ...
        options: _objectSpread(_objectSpread({}, options), {}, {
          data: (0, _mapValues2["default"])(options.data, function (v) {
            return (0, _isUndefined2["default"])(v) ? null : v;
          })
        })
      };
    }
