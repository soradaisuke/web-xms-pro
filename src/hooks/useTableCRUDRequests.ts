...
import { concat, isFunction, isString, join, map, merge, replace, toPairs } from 'lodash';
...
export type TableDeleteServiceConfig =
  & DeleteServiceConfig<
    [id: string | number]
  >
  & {
...
export type TableRetrieveServiceConfig<TData = CommonRecord> = RetrieveServiceConfig<TData> & {
